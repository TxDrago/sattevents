...
const EventStoryCTA = ({ event }) => {
  ...
  const backgroundImage = event?.heroImage || null;
  ...
  return (
    <section className="relative overflow-hidden bg-black py-28 text-white md:py-40">
      ...
      <div className="relative z-10 mx-auto max-w-[1100px] px-6 text-center">
        ...
        >
          {cta.eyebrow && (
            <span className="text-[24px] font-bold uppercase tracking-[0.3em] text-[var(--satt-gold)]">
              {cta.eyebrow}
            </span>
          )}
          ...
          <Link
            href="/contact"
            className="group mt-10 inline-flex items-center gap-4 border border-[var(--satt-gold)] bg-[var(--satt-gold)] px-7 py-4 text-[16px] font-bold uppercase tracking-[0.18em] text-black transition-all duration-300 hover:bg-[var(--satt-gold-dark)] hover:text-white"
          >
